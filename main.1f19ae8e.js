...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    m: function mount(target, anchor, remount) {
      ...
      ctx[6]), (0, _internal.listen_dev)(button0, "click",
      /*submit*/
      ctx[2], false, false, false), (0, _internal.listen_dev)(textarea1, "input",
      /*textarea1_input_handler*/
      ctx[7]), (0, _internal.listen_dev)(button1, "click",
      /*download*/
...
function decode_true_false(true_false) {
  var qa = /*#__PURE__*/_wrapRegExp(/\t[0-9]+\.\t(.+)\n+ANS:\t([FT])/gm, {
    question: 1,
    answer: 2
  });
...
function encode_true_false(true_false) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var tf = _step.value;
      results.push("TF\t".concat(tf.question, "\t").concat(answer_lookup[tf.answer], "\tincorrect"));
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function decode_multiple_choice(multiple_choice) {
  var mc = /*#__PURE__*/_wrapRegExp(/\t[0-9]+\.\t(.+)\n(([a-z]\.\n.+\n)+)\n+ANS:\t([A-Z])/gm, {
    question: 1,
    choices: 2,
    answer: 4
  });
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      var c = /*#__PURE__*/_wrapRegExp(/([a-z])\.\n(.+)\n/gm, {
        label: 1,
        choice: 2
      });
...
function decode_matching(matching) {
  ...
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      ...
      var a = /*#__PURE__*/_wrapRegExp(/([a-z])\.\n(.+)\n/gm, {
        label: 1,
        answer: 2
      });

      var q = /*#__PURE__*/_wrapRegExp(/\t([0-9]+)\.\t(.+)\n/gm, {
        label: 1,
        question: 2
      });

      var qa = /*#__PURE__*/_wrapRegExp(/\t([0-9]+)\.\tANS:\t(.+)\n+/gm, {
        question_label: 1,
        answer_label: 2
      });
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$inject_state = function ($$props) {
    ...
    if ("internalContent" in $$props) internalContent = $$props.internalContent;
    if ("outputContent" in $$props) $$invalidate(1, outputContent = $$props.outputContent);
  };
